...
public class Locale {
    ...
    public static String ERROR_MOJANG_API_OFFLINE = "&4Error&8: &cMojang API is currently offline, sadly we were not able to find your archived skin. \n&cPlease try again later...";
    public static String ERROR_MS_API_OFFLINE = "&4Error&8: &cMineSkin APII is currently offline, sadly we can't create custom skin's at this moment. \n&cPlease try again later...";
    public static String ERROR_SERVER_OFFLINE = "&4Error&8: &cServer is having connection issues, please try again later...";
