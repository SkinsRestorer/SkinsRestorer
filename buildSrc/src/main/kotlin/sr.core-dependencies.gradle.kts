...
dependencies.testImplementation("org.junit.jupiter:junit-jupiter-api:5.9.2")
dependencies.testRuntimeOnly("org.junit.jupiter:junit-jupiter-engine:5.9.2")
...
dependencies.testImplementation("org.mockito:mockito-junit-jupiter:4.8.0")
